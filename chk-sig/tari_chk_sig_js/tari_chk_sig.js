...
* @returns {any}
*/
module.exports.check_signature = function(pub_nonce, signature, pub_key, msg) {
    const ptr0 = passStringToWasm0(pub_nonce, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(signature, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(pub_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.check_signature(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
...
const path = require('path').join(__dirname, 'tari_chk_sig_bg.wasm');
